...
type
  TfrmCadastroDasReceitas = class(TfrmHerancaCadastro)
    QryCadastroreceitaId: TIntegerField;
    QryCadastrotipoReceita: TWideStringField;
    QryCadastrodetalhamento: TWideStringField;
    QryCadastrovalorReceita: TFloatField;
    QryCadastrofonte: TWideStringField;
    QryCadastrodataReceita: TDateTimeField;
...
var
  frmCadastroDasReceitas: TfrmCadastroDasReceitas;
